...
// let Staff = 'Samah'
// let Salary = 8000
// let SalaryByDay = Math.round(Salary / 30)
// let SalaryByHour = Math.round(SalaryByDay / 10)

// let staffDiscounts

// let staffOverTime

// let SalaryAfterOverDiscount

// let timeOfPresenceByH = 13
// let timeOfPresenceByM = 0

// let realPresenceByH = 14
// let realPresenceByM = 30

// let timeOfDepartureByH = 23
// let timeOfDepartureByM = 0

// let realDepartureByH = 23
// let realDepartureByM = 15 

// let Loans = 1000

// function calcSalary(){

//     let LateByH = realPresenceByH - timeOfPresenceByH
//     let LateByM = realPresenceByM - timeOfPresenceByM
//     let Late = LateByH * 60 + LateByM
//     let staffDiscounts = (Late / 60) * SalaryByHour

//     let OverByH = realDepartureByH - timeOfDepartureByH
//     let OverByM = realDepartureByM - timeOfDepartureByM
//     let Over = OverByH * 60 + OverByM
//     let staffOverTime = (Over / 60) * SalaryByHour

//     let SalaryAfterOverDiscount = (Salary + staffOverTime) - (staffDiscounts + Loans)
...
//     RealPresence = ${realPresenceByH}:${realPresenceByM}
//     Late = ${LateByH}:${LateByM} / Mony = - ${staffDiscounts}

//     RealDeparture = ${realDepartureByH}:${realDepartureByM}
//     Over = ${OverByH}:${OverByM} / Mony = + ${staffOverTime}
...
//     Loans = ${Loans}
//     SalaryAfterCalc = ${SalaryAfterOverDiscount}
...
//         <h3 style="width: 40px;" class="d-flex justify-content-center align-items-center">${i+1}</h3>

//         <div class="mx-auto d-flex justify-content-center align-items-center">
//           <i class="fa-solid fa-arrow-right-to-bracket fs-3 me-1"></i>
//           <input type="time" class="form-control">
//         </div>

//         <div class="mx-auto d-flex justify-content-center align-items-center">
//           <i class="fa-solid fa-arrow-right-from-bracket fs-3 me-1"></i>
//           <input type="time" class="form-control">
//         </div>
...
//     document.getElementById('Days').innerHTML = cartona
// }
